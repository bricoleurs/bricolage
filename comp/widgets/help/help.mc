...
</%perl><a href="#" onClick="window.open('<% $uri %>', 'Help_<% SERVER_WINDOW_NAME %>', 'menubar=0,location=0,toolbar=0,personalbar=0,status=0,scrollbars=1,height=600,width=620');return false;"><img src="/media/images/help.gif" border="0" width="71" height="20" alt="Help"></a>
