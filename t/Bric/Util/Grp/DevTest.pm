...
sub test_list : Test(70) {
    ...
    ok( my @grps = Bric::Util::Grp->list({ name => 'All%' }),
        "get all All groups" );
    is( scalar @grps, 23, "Check number of All groups" );
    ...
    is( scalar @grps, 31, "Check number of permanent groups" );
...
sub test_list_ids : Test(10) {
    ok( my @grp_ids = Bric::Util::Grp->list_ids({ name => 'All%' }),
        "get all All groups" );
    is( scalar @grp_ids, 23, "Check number of All group IDs" );
    ...
    is( scalar @grp_ids, 31, "Check number of permanent group IDs" );
