...
sub test_burn : Test(121) {
    ...
    return $self->subclass_burn_test(
        'TemplateToolkit',
        'tt',
        Bric::Biz::ElementType::BURNER_TT,
    );
}
...
</blockquote><p>圳地在圭圬圯圩夙多夷夸妄奸妃好她如妁字存宇守宅安寺尖屹州帆并年</p><p>橿梶鰍潟割喝恰括活渇滑葛褐轄且鰹叶椛樺鞄株兜竃蒲釜鎌噛鴨栢茅萱</p><p>뼈뼉뼘뼙뼛뼜뼝뽀뽁뽄뽈뽐뽑뽕뾔뾰뿅뿌뿍뿐뿔뿜뿟뿡쀼쁑쁘쁜쁠쁨쁩삐</p><blockquote>
