...
For example, lets say we publish a Column story in the News/Politics category
...
and therefor use more system resources (memory). It would be better to load all of
