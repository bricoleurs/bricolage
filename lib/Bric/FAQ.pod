...
I'm not sure why the IDENT fails. In inst/db_grant.pl,
we switch EUID to that of 'postgres'. Maybe more things
need to be set in order to convince postgresql that
you're logging in as 'postgres' instead of 'root'?
...
=head3 I'm trying to restore a backup of the Bricolage database, but I keep
getting an error like this: "ERROR: Function login_avail(varchar, numeric,
numeric) does not exist". What gives?
