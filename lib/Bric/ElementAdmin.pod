...
types. These latter items are basically groupings of elements, where certain
properties of all of the elements of that type are set. Based on the above
examples, here's the breakdown of element types and elements:

Here is a list of the Element Types we'll need to create:
...
Basically these Element Types cover the various categories of elements that
we'll use. Here's a breakdown of the elements we'll need to create:

=over 4

=item Cover

This element is the Story Type for covers. Its Element Type is "Covers."

=item Column One

This element will hold all of the subelements in the first column of cover
stories. Its Element Type is "Columns."

=item Column Two

This element will hold all of the subelements in the second column of cover
stories. Its Element Type is "Columns."

=item Column Three

This element will hold all of the subelements in the third column of cover
stories. Its Element Type is "Columns."
...
Now that the Element Type has been defined, we need to create an actual "Cover"
