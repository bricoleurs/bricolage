...
Document the use of Cache::FileCache in Bric::Admin, especially how it lives in
/tmp/FileCache [David].

=item *

Add ability to set permissions on assets based on the categories they're in
[David].
...
Have Bric::Util::Class use Bric::Util::Cache [David].
...
Add Explanation/Philosophy statement linkable from the logo (make French
speakers more comfortable with the name) [David].
...
Create localization libraries for all text.
