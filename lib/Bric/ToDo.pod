...
who don't have READ permission on a category or asset type should't see it in
the select lists [David].
...
Have Bric::Util::Class use Bric::App::Cache [David].
...
there is in general more control over how the fields are created [David].
...
pass in arguments to list()? [David]
