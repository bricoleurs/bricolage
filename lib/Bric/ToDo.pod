...
Add a "preview" action to the Story and Media SOAP interfaces. It will work
just like "publish" except, of course, that it "previews" and doesn't checkin
the assets or remove them from desks or workflows.
