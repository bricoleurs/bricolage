...
Add name of Output Channel to list of Templates in Find Templates interface
[Michele].
...
allow only one template with a given name for a given category and output
channel.
