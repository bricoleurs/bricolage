...
Add search by category (including secondary categories) and search by
story/media type to the Find Stories and Find Media interfaces. This feature
would be in the Advanced search interface, but for those who want to have it
present all the time, see the next item.
