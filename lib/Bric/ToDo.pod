...
Add second screen to New Template to get file fype with only choices
valid for the chosen element type's burner. [Sam]

=item *

Add configuration option for selecting a subset of available Burners. [Sam]
