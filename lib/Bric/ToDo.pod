...
Refactor the category object and related code to make the uri tree forms
more easily searched and sorted.  This might replace or use the
category_full_path function.
