...
Bric::Util::Attribute::Member currently inherits all methods from
...
B<Notes:> Values for this method look like 'member' given a full object type of
'Bric::Util::Member'.

=cut

sub short_object_type { return 'member' }
...
B<Notes:> Values for this method look like 'Bric::Util::Grp::Parts::Member'.

=cut

sub full_object_type { return 'Bric::Util::Grp::Parts::Member' }
...
L<Bric|Bric>, 
L<Bric::Util::Member|Bric::Util::Member>, 
