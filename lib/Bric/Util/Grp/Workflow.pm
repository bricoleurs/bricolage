...
use constant OBJECT_CLASS_ID => 44;
...
=item my @list_classes = Bric::Util::Grp::Workflow->get_list_classes
...
sub get_list_classes { ('Bric::Biz::Workflow') }

################################################################################

=item $class_id = Bric::Util::Grp::Workflow->get_object_class_id
...
L<Bric|Bric>, 
L<Bric::Biz::Workflow|Bric::Biz::Workflow>, 
