...
=item $supported_classes = Bric::Util::Grp::OutputChannel->get_supported_classes()
...
sub get_list_classes { ('Bric::Biz::OutputChannel') }

################################################################################

=item $class_id = Bric::Util::Grp::OutputChannel->get_object_class_id
...
=item $class_id = Bric::Util::Grp::OutputChannel->get_class_id()
...
=item my $secret = Bric::Util::Grp::OutputChannel->get_secret()
...
=item my $class = Bric::Util::Grp::OutputChannel->my_class()
...
=item my $class = Bric::Util::Grp::OutputChannel->member_class()
