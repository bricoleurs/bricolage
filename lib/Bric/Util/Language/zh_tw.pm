...
our %Lexicon =
    (
     ...
     'All Types' => '所有類型' ,
     'An "[_1]" attribute already exists. Please try another name.' => ' 「[_1]」 屬性已經存在，請選擇別的名稱' ,
     ...
     'Warning:  Use of element\'s \'name\' field is deprecated for use with element method \'get_data\'.  Please use the element\'s \'key_name\' field instead.' => '警告: 以 \'name\' 欄位呼叫 \'get_data\' 的使用方式已被廢棄不用。請改用元素的 \'key_name\' 欄位。',
