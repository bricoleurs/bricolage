...
our %Lexicon = (
    ...
    'An "[_1]" attribute already exists. Please try another name.' => 'L\'attributo "[_1]" esiste gi‚Ã‚ . Per favora prova con un altro nome.',
   ...
   'Manage' => 'Gestire',
   'An active template already exists for the selected output channel, category, element and burner you selected.  You must delete the existing template before you can add a new one.' => 'Esiste gi‚Ã‚  un template attivo per questo canale di distribuzione, categoria, elemento e burner selezionato. Cancellate il template esistente per poterne aggiungere uno nuovo.',
   'Select' => 'Selezionare',
