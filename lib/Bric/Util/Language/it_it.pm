...
our %Lexicon = (
    ...
    'Login [_1] is already in use. Please try again.' => 'Il login [_1]  giˆ attivo. prova di nuovo.',
    ...
    'The name [_1] is already used by another Source.' => 'Il nome [_1] j gia in uso',
    ...
    'An error occurred while processing your request:' => 'Si  verificato un errore durante l\'esecuzione della tua richiesta:',
    '404 NOT FOUND' => '404 - File non trovato',
    'URL' => 'URL',
    'An error occurred.' => 'Si  verificato un errore.',
    'Sort By' => 'Ordina per',
    'Template [_1] saved.' => 'Template [_1] salvato.',
    'The URL you requested, <b>[_1]</b>, was not found on this server' => 'L\'URL richiesto, <b>[_1]</b>, non  disponibile',
    'Members' => 'Membri',
    'Deploy' => 'Implementare',
    'Delete this Category and All its Subcategories' => 'Cancella questa categoria e le SottoCategorie collegate',
    'Cannot move [_1] asset \'[_2]\' while it is checked out' => 'Non  possibile spostare l\'asset [_1] perchŽ  riservato.',
    ...
    'No elements have been added.' => 'Non  stato aggiunto alcun elemento.',
    'Name' => 'Nome',
    'My Workspace' => 'Area di lavoro personale',
    'The name [_1] is already used by another [_2].' => 'Il nome [_1]  giˆ stato usato da un altro utente [_2].',
    ...
    'The name [_1] is already used by another Element Type.' => 'Il nome [_1]  giˆ usato da un altro Tipo di Elemento.',
    ...
    'Warning: object [_1]\' had no associated desk.Ê It has been assigned to the [_2]\' desk.' => 'Attenzione: l\'oggetto [_1]\' non ha nessun desk associato. E\' stato assegnato al desk [_2]\'.',
    ...
    'Desk profile [_1] deleted from all workflows.' => 'Profilo del Desk [_1] cancellato da tutti iÊ workflow.',
    ...
    'The name [_1] is already used by another Workflow.' => 'Il nome [_1]  giˆ usato da un altro Workflow.',
    'Login cannot be blank. Please enter a login.' => 'Il login non pu˜ essere vuoto. Per favore inserite un altro login.',
    'Label' => 'Etichetta',
    'Output Channel profile [_1] saved.' => 'Profilo del Canale di Distribuzione [_1] salvato.',
    'Move Assets' => 'Muovi gli asset',
    'Category [_1] cannot be deleted.' => 'La categoria [_1] non pu˜ essere cancellata.',
    ...
    'Using Cyclops without JavaScript can result in corrupt data and system instability. Please activate JavaScript in your browser before continuing.' => 'Utilizzare Cyclops senza JavaScript pu˜ condurre a errori sui dati e instabilitˆ. Attivate JavaScript nel browser prima di continuare.',
    ...
    'Cannot publish checked-out media [_1]' => 'Non  possibile pubblicare il media [_1] in check out',
    ...
    'No file has been uploaded' => 'Nessun file  stato uploadato',
    'Select Role' => 'Seleziona il Ruolo',
    'Caption' => 'Titolo',
    'Login must be at least [_1] characters.' => 'il login deve avere almeno [_1] caratteri.',
    'Passwords do not match!Ê Please re-enter.' => 'La passoword non corrisponde. Riprova.',
    'The name [_1] is already used by another Output Channel.' => 'Il nome [_1]Ê  giˆ in uso per un altro Canale di Distribuzione.',
    ...
    'Roles' => 'Ruoli',
    'Warning: [_1] object \'[_2]\' had no associated workflow.Ê It has been assigned to the \'[_3]\' workflow.' => 'Attenzione: l\'oggetto [_1] \'[_2]\' non  associato a nessun workflow. E\' stato associato al workflow \'[_3]\'.',
    'Size' => 'Dimensione',
    ...
    'The cover date has been reverted to [_1], as it caused this story to have a URI conflicting with that of story \'[_2].' => 'La data della cover  stata modificata in [_1], perchŽ in conflitto con quella dell\'Storia [_2].',
    ...
    'Group cannot be deleted' => 'Il Gruppo non pu˜ essere cancellato',
    'Page' => 'Pagina',
    ...
    'An [_1] attribute already exists. Please try another name.' => 'L\'attributo [_1] esiste giˆ. Per favora prova con un altro nome.',
    ...
    'Cannot publish checked-out story [_1]' => 'Non  possibile pubblicare la Storia in check out [_1]',
 Ê		   'Grant [_1] members permission to access assets in these workflows.' => 'Consenti ai membri del gruppo [_1] l\'accesso agli asset di questo workflow.',
   ...
   'Jobs' => 'Jobs',
   'Content' => 'Contenuto',
   'The name [_1] is already used by another Media Type.' => 'il nome [_1]  giˆ in uso per un altro Tipo di Media.',
   'Current Version' => 'Versione Corrente',
   'Create a New Category' => 'Creare un Nuova Categoria',
   'First' => 'Nome',
   'URI [_1] is already in use. Please try a different directory name or Parent.' => 'URI [_1] giˆ in uso Per favore utilizza un nome di categoria o \'parent\' differente.',
   ...
   'The category was not added, as it would have caused a URI clash with story [_1].' => 'Non  stato possibile aggiungere la categoria perchŽ in conflitto di URI con la Storia [_1].',
   ...
   'Manage' => 'Gestire',
   'An active template already exists for the selected output channel, category, element and burner you selected.  You must delete the existing template before you can add a new one.' => 'Esiste giˆ un template attivo per questo canale di distribuzione, categoria, elemento e burner selezionato. Cancellate il template esistente per poterne aggiungere uno nuovo.',
   'Select' => 'Selezionare',
   ...
   'Cannot publish [_1]  because it is checked out' => 'Non  possibile pubblicare [_1] perchŽ  in checkout.',
   ...
   'Cannot auto-publish related media [_1] because it is checked out' => 'Non  possibile pubblicare in automatico il media correlato [_1] perchŽ l\'elemento  in checkout.',
   'Last Name' => 'Cognome',
   ...
   'ADVANCED SEARCH' => 'RICERCA AVANZATA',
   'Text box' => 'Text box',
   'The slug has been reverted to [_1], as the slug [_2] caused this story to have a URI conflicting with that of story [_3].' => 'Identificatore di URI [_2] modificato in [_1], perchŽ in conflitto con l\'URI della storia [_3].',
   'Value Name' => 'Valore',
   'Expire' => 'Scadenza',
   ...
   'Last' => 'Ultimo',
   'Warning! Cyclops is designed to run with JavaScript enabled.' => 'Attenzione! Cyclops  progettato per funzionare con javascript attivato.',
   'Add to Element' => 'Aggiungere all\'Elemento',
   'Passwords must match!' => 'La Password deve corrospondere!',
   'The URI of this media conflicts with that of [_1].  Please change the category, file name, or slug.' => 'L\'URI di questo media  in conflitto con [_1]. Per favore modifica la categoria, il nome del file o lo slug.',
   'PREFERENCES' => 'PREFERENZE',
   'Workflows' => 'Workflow',
   ...
   'The slug can only contain alphanumeric characters (A-Z, 0-9, - or _)!' => 'L\'identificatore di URL (slug) pu˜ contenere solo caratteri alfanumerici (A-Z, 0-9, - ou _)!',
   ...
   'Source' => 'Fonte',
   'This story has not been assigned to a category.' => 'La Storia non  stata assegnata ad alcuna categoria.',
   ...
   '[_1] cannot be deleted' => '[_1] non pu˜ essere cancellato',
   ...
   'Cannot cancel [_1] because it is currently executing.' => 'Non  possibile cancellare [_1] perchŽ in esecuzione.',
