...
our %Lexicon = (
    ...
    'Login [_1] is already in use. Please try again.' => 'Il login [_1]  gi attivo. prova di nuovo.',
    ...
    'Cannot move [_1] asset \'[_2]\' while it is checked out' => 'Non  possibile spostare l\'asset [_1] perch  riservato.',
    ...
    'The name [_1] is already used by another [_2].' => 'Il nome [_1]  gi stato usato da un altro utente [_2].',
    ...
    'The name [_1] is already used by another Element Type.' => 'Il nome [_1]  gi usato da un altro Tipo di Elemento.',
    ...
    'The name [_1] is already used by another Workflow.' => 'Il nome [_1]  gi usato da un altro Workflow.',
    ...
    'Using Cyclops without JavaScript can result in corrupt data and system instability. Please activate JavaScript in your browser before continuing.' => 'Utilizzare Cyclops senza JavaScript pu condurre a errori sui dati e instabilit. Attivate JavaScript nel browser prima di continuare.',
    ...
    'The name [_1] is already used by another Output Channel.' => 'Il nome [_1]�  gi in uso per un altro Canale di Distribuzione.',
    ...
    'Roles' => 'Ruoli',
    'Warning: [_1] object \'[_2]\' had no associated workflow.� It has been assigned to the \'[_3]\' workflow.' => 'Attenzione: l\'oggetto [_1] \'[_2]\' non  associato a nessun workflow. E\' stato associato al workflow \'[_3]\'.',
    'Size' => 'Dimensione',
    ...
    'The cover date has been reverted to [_1], as it caused this story to have a URI conflicting with that of story \'[_2].' => 'La data della cover  stata modificata in [_1], perch in conflitto con quella dell\'Storia [_2].',
    ...
    'An [_1] attribute already exists. Please try another name.' => 'L\'attributo [_1] esiste gi. Per favora prova con un altro nome.',
 ...
 �		   'Grant [_1] members permission to access assets in these workflows.' => 'Consenti ai membri del gruppo [_1] l\'accesso agli asset di questo workflow.',
   ...
   'Jobs' => 'Jobs',
   'Content' => 'Contenuto',
   'The name [_1] is already used by another Media Type.' => 'il nome [_1]  gi in uso per un altro Tipo di Media.',
   'Current Version' => 'Versione Corrente',
   'Create a New Category' => 'Creare un Nuova Categoria',
   'First' => 'Nome',
   'URI [_1] is already in use. Please try a different directory name or Parent.' => 'URI [_1] gi in uso Per favore utilizza un nome di categoria o \'parent\' differente.',
   ...
   'The category was not added, as it would have caused a URI clash with story [_1].' => 'Non  stato possibile aggiungere la categoria perch in conflitto di URI con la Storia [_1].',
   ...
   'Manage' => 'Gestire',
   'An active template already exists for the selected output channel, category, element and burner you selected.  You must delete the existing template before you can add a new one.' => 'Esiste gi un template attivo per questo canale di distribuzione, categoria, elemento e burner selezionato. Cancellate il template esistente per poterne aggiungere uno nuovo.',
   'Select' => 'Selezionare',
   ...
   'Cannot publish [_1]  because it is checked out' => 'Non  possibile pubblicare [_1] perch  in checkout.',
   ...
   'Cannot auto-publish related media [_1] because it is checked out' => 'Non  possibile pubblicare in automatico il media correlato [_1] perch l\'elemento  in checkout.',
   'Last Name' => 'Cognome',
   ...
   'ADVANCED SEARCH' => 'RICERCA AVANZATA',
   'Text box' => 'Text box',
   'The slug has been reverted to [_1], as the slug [_2] caused this story to have a URI conflicting with that of story [_3].' => 'Identificatore di URI [_2] modificato in [_1], perch in conflitto con l\'URI della storia [_3].',
   'Value Name' => 'Valore',
   'Expire' => 'Scadenza',
   ...
   'Cannot cancel [_1] because it is currently executing.' => 'Non  possibile cancellare [_1] perch in esecuzione.',
