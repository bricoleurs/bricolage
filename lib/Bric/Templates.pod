...
Before taking about templates, lets take a moment to discuss all the major
...
element objects are an object representation the story data for a data element.
...
Furthermore the 'get_elements' method returns us some container element objects
