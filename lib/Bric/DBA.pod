...
The C<autovacuum> directive turns on the autvacuum daemon that is included in
...
and/or C<stats_row_level>, autovacuum will not actually work. But it's not
fatal; you'll just happen to see this warning if you're watching your
PostgreSQL log:
