...
Added two search fields to Advanced Search in 'Find Stories' and 'Find Media':
the 'Include deleted' checkbox allows searching for and reactivating deleted
Stories and Media, while the 'Subelement' dropdown allows searching on Stories
by subelement. [Scott]
