...
Fixed the "story__category" table to use the correct sequence the for they id
...
specification of outpout channels when returning URIs. Thanks to JosE<eacute>
Castro. [Marshall]
