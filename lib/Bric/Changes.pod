...
that does not exist" message would not clear and the form would not think that
the category is legal. Could apply to other categories, but was most common
for the root category. Thanks to Michael Herring for the detailed steps to
