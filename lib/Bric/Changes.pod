...
Fixed bug in Bric::SOAP::Element where elements updated with
bric_dev_sync weren't being used by existing stories.
...
This is useful to avoid timing out on long runs.
