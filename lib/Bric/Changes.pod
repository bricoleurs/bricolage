...
Added C<mark_as_published> method to L<Bric::Biz::Asset::Business>. This marks
an asset as published in the database but does not create jobs or resources 
and no templates will be called. 
