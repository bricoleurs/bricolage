...
properly exports C<catfile()>.

C<--from--site> and C<--to-site> were trying to search on output channel
rather than site.  This is also fixed.  [Ovid]
...
plaintext password in the history. [Marshall]
