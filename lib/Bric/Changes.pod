...
Added support for C<ANY()> function to pass multiple possible values for a
given parameter to the C<list()> method in Bric::Util::Grp. More classes will
support it soon! Sponsored by Alinghi. [David]
