...
noticed with with Mozilla on Mac OS X, and presume it would happen
elsewhere, too. [David]
...
Fixed installation to work under Debian Linux 3.0 (testing).  Thanks
to Mark Jaroski for a helpful patch.  [Sam]
...
Removed MD5 Perl module requirment by requiring Apache::Session 1.54 or higher.
[David]
...
check of the temlate just as saving the template does. [Joao Pedro
Goncalves]
