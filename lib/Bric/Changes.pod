...
are to the interfaces of L<Bric::Biz::AssetType|Bric::Biz::AssetType>,
...
The old methods are of course left in place for purposes of backwards
compatibility. [David]

=item *

Added C<get_values()> and C<set_values()> methods to the field class
(Bric::Biz::Asset::Business::Parts::Tile::Data) to make getting and
