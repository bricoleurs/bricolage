...
order to not publish them. [Scott]
...
Publication of stories and media the automatically schedule expiration jobs no
longer cause an error. Reported by Marshall Bloch. [David]
