...
Publishes no longer fail with the error message 'Can't call method "get_id" on
an undefined value' when the story being published is currently checked out to
a user. Reported by Scott (Bug #1417). [David]
