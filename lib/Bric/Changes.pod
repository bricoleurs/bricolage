...
The XML generated when exporting element types via SOAP no longer inccludes
...
Reverting stories and media no longer leads to occaisional errors such as,
...
The "Allow Multiple" checkbox in the "Add New Field" section of the element
type profile works again. Reported by Rod Taylor. [David]
