...
inst/upgrade/1.7.0/data_tile_key_name.pl will skip upgrading "key_name"
if it would be no different than "name". This can save a lot of time
during upgrade if your database is large. [Scott]
