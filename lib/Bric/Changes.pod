...
Added support for MySQL, from Andrei Arsu's Google Summer of Code project.
...
Fixed a bug (svn 1039) in Container.pm that was preventing trunk from starting up [Beaudet]
