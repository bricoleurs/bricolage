...
Fixed German localization of javascript error messages. [Steffen Schwigon]
...
Localization patch for the "and" and "to" of "and Shelve", etc., with German
translations from Steffen Schwigon. [Scott]
...
directory, instead over replacing the existing F<Pg.sql>. [David]
...
defined in F<bricolage.conf>. Use this ID when writing user stylesheets to
override the look of the Bricolage UI (see SkinningBricolage in the Wiki)
[Marshall]
