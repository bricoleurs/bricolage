...
Added configuration directive to allow the expiration of assets when they are deleted.
[David, Mercier, Rolf and Herring]
...
Fixed bug #1426, find stories/media/template advanced search toggle now works properly.
[Sarah Mercier and Matt Rolf]
