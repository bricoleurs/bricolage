...
Added reverse date sorting option on desks (newest items first). Suggested
by Bret Dawson. [Greg Heo]
...
Updated SFTP.pm to use the faster Net::SSH2. [Sarah Mercier, Matt Rolf, Charlie Reitsma, Michael Herring]
