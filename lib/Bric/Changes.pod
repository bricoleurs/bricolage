...
new image elements created after upgradeing to 1.7.0. [David]
...
The creation of the Bricolage PostgreSQL user during installtion no longer
complains about usernames with dashes and other non-alphanumeric characters in
them. Thanks to Marshall Roch for the spot! [David]
