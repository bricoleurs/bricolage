...
Removed the mostly unused and meaningless C<publishable> attribute from
L<Bric::Biz::ElementType::Parts::FieldType|Bric::Biz::ElementType::Parts::FieldType>.
[David]
...
Renamed Bric::SOAP::ElementType to Bric::SOAP::ATType and Bric::SOAP::Element
to L<Bric:SOAP::ElementType|Bric:SOAP::ElementType>. [David]
