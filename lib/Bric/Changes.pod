...
Removed "New Alias" link in workflows if there's only one site. [Scott]
...
In F<lib/Bric/Biz/AssetType/Parts/Data.pm> constant ORD, changed 'name'
to 'key_name' (name was replaced with key_name throughout that module,
by the way...) [Scott]
