...
folks from creating new contributor rols in the UI only to find that Bricolage
...
profiles, the maximum length of text and textarea fields is no "0", or
unlimited. [David]
...
all sites instead of none. [Joao Pedro]
...
friendly error message again.  This was broken by the change in 1.7.2
that made the Mason burner use document templates as true dhandlers.
[Dave Rolsky]
