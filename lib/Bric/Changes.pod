...
Added the methods C<page_file()> and C<page_uri()> to
Bric::Util::Burner::Mason. When passed a page number argument, these methods
return the strings representing the file names or URIs of the given page in
the curently-burning story and, in the case of the C<page_uri()> method,
appropriate to the currently-burning Output Channel. [David]
