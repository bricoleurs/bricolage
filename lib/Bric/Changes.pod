...
using Apache 1.3 is not currently supported. [Scott, Chris Heiland, David]
...
F<inst/cpan.pl> now explicitly loads L<CPAN::Queue|CPAN::Queue>, since it
appears that some newer versions of L<CPAN|CPAN> may not load it themselves.
Reported by Jean-Michel Caricand. [David]
