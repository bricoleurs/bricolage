...
The Mason burner now uses document templates as true dhandlers, enabling
inheritance to autohandlers to work properly. [David & Dave Rolsky]
...
Berkus (under sponsorship from WHO), searches for stories are now up to ten
