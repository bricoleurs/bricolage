...
LoadModule and AddModule httpd.conf directives should now be generated properly
during installation.  LoadModule will use config_log_module or mod_log_config 
depending on the system, but AddModule will always use mod_log_config.c. 
Spotted by Dave Jablonski. [Marshall]
