...
Added F<bric_xfer_grps> and F<bric_xfer_users> to F<contrib/bric_xfer>.
They use the Bric API to transfer Groups between bricolages. [Scott]
...
instead of the default "postgres" username and emtpy password. Thanks to Paul
