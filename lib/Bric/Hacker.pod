...
By far, the most common merge will be from a release branch (e.g.
rev_1_8) to trunk.  For this reason, the documentation below will assume
that you are merging from a branch to trunk; however, there is still occasion 
to merge between branches, e.g. rev_1_6 to rev_1_8.  In these cases, use 
"rev_1_X" instead of "trunk".
...
number of the merge itself.  For example, if a merge was committed to the
trunk from the rev_1_8 branch in revision 5694, the branch would be located
at F<tags/rev_1_8/trunk-5694>.
...
C<list> command to find it:
  ...
  % svn list https://svn.bricolage.cc/bricolage/tags/rev_1_8 | grep trunk
  trunk-5694/
  trunk-5825/
  trunk-5902/
  trunk-5995/
...
know to merge only from that revision on.
  ...
  % svn cp -m 'Tag for merge to trunk revision 6123.' \
    https://svn.bricolage.cc/bricolage/branches/rev_1_8 \
    https://svn.bricolage.cc/bricolage/tags/rev_1_8/trunk-6123
