...
this:
  ...
  File: README            Status: Up-to-date
     ...
     Sticky Tag:          rev_1_4_0 (branch: 1.16.2)
     Sticky Date:         (none)
     Sticky Options:      (none)

     Existing Tags:
          rev_1_4_0                   (branch: 1.16.2)
          rev_1_4_0_merge-2002-08-31  (revision: 1.16.2.1)
          Dev-rev_1_3_3               (revision: 1.10)
          rev_1_2_merge-2002-04-03    (revision: 1.2.2.4)
          rev_1_2_3                   (revision: 1.2.2.4)


From this output, you can see that, for this branch (rev_1_4_0), the file
was tagged with the merge tag "rev_1_4_0_merge-2002-08-31". Thus we can
...
from HEAD, make sure it's fully up-to-date, and do a simple merge:
  ...
  cvs -z3 -q update
  cvs -z3 -q update -kk -j rev_1_4_0

Otherwise, do a merge from the most recently-dated merge tag. In the above
example, that would be "rev_1_4_0_merge-2002-08-31".

  cd bricolage-head-checkout/
  cvs -z3 -q update
  cvs -z3 -q update -kk -j rev_1_4_0_merge-2002-08-31 \
    -j rev_1_4_0
...
only from this date on.
  ...
  cd bricolage-branch-checkout/
  cvs -z3 -q tag rev_1_4_0_merge-CCYY-MM-DD
...
option with C<export> so that the version numbers are all properly populated.
  ...
  cd /tmp
  cvs -z3 export -r rev_1_x_x -kkv bricolage
  cd bricolage
  make dist
