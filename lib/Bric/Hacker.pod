...
bug and fix them.  For more things to do see L<Bric::Todo>.
...
Turn on DBI_DEBUG in your bricolage.conf.  DBI_DEBUG causes every
database call made in the application to generate a subroutine call
trace in the logs.  This generates a lot of data but it can be very
helpful.
