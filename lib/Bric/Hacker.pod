...
from HEAD and do a simple merge:

  cd bricolage-head-checkout/
  cvs -z3 -q update -j Release_1_4_0
...
example, that would be "Release_1_4_0_merge-2002-08-31".
  ...
  cvs -q3 -q update -j Release_1_4_0_merge-2002-08-31 \
    -j Release_1_4_0

=item 3

Resolve any conflicts (hopefully none, but they do happen occaisionally) and
