...
otherwise we would be indundated with spam. Please subscribe before posting.

Subscribe: L<http://lists.sourceforge.net/lists/listinfo/bricolage-general>

Archives: L<http://marc.theaimsgroup.com/?l=bricolage-general>

=item bricolage-announce@lists.sourceforge.net

Official announcements from the Bricolage team. These are always Cc'd to
Bricolage-General, so you need not subscribe to both. Very low
traffic. (read-only except for core developers)

Subscribe: L<http://lists.sourceforge.net/lists/listinfo/bricolage-announce>
...
Subscribe: L<http://lists.sourceforge.net/lists/listinfo/bricolage-devel>

Archives: L<http://marc.theaimsgroup.com/?l=bricolage-devel>

=item bricolage-commits@lists.sourceforge.net

CVS context diffs for all checkins to the Bricolage repository. (read-only).

Subscribe: L<http://lists.sourceforge.net/lists/listinfo/bricolage-commits>
...
Bugzilla: L<http://bugzilla.bricolage.cc/>

Subscribe: L<http://lists.sourceforge.net/lists/listinfo/bricolage-bugs>
...
in, and the name of the new tag you'll creeate for the branch. The final
...
commit changes to a tag after it has been created.
...
any changes, be sure to commit them to the Subversion repository and then to
update the tag, then do the whole thing over again. Once everything appears to
