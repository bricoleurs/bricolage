...
Install Apache 1.3.34 or greater with mod_perl, mod_log_config, mod_mime, and
...
Apache 1.3.34 or later

=item *

mod_perl 1.xx or later - Apache/Perl Integration
...
SFTP servers (e.g. pure-ftpd has been reported to need this) to correctly
handle uploads of already existing files: when publishing via FTP, Bricolage
first creates a temporary file, than moves this temp file over the existing,
