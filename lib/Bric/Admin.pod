...
$Log: Admin.pod,v $
Revision 1.5.2.7  2001-10-05 16:15:36  wheeler
Updated Cache::Cache requirement to 0.9, since that's the first version to ship
with the Artistic License as well as the GPL. Previous verions were GPL only,
and we need to steer clear of that license in order to maintain our own.

Revision 1.5.2.6  2001/10/05 10:08:40  wheeler
Added XML::Writer to the list of required Perl modules.

Revision 1.5.2.5  2001/10/05 09:33:31  wheeler
Documented XML::Writer configuration directives.
