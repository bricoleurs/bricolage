...
directory). Session files are stored in C<$TMP/bricolage_session> and
C<$TMP/bricolage_lock>. These directories should stay relatively free of cruft,
...
C<$TMP/bricolage_cache>. The files in this directory can be periodically
