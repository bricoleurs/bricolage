...
=item Unix::Syslog 0.95

=item Bundle::libnet 1.0703
...
PostgreSQL, and 'db_user' and 'db_password' are the user name and
...
The Apache OpenSSL interface (mod_ssl) is an optional part of the Bricolage
...
B<SSL_ENABLE:> Set this option to 1 to enable SSL support.  Make
sure you've followed the installation instructions for building a
mod_ssl Apache.  This is set to 0 by default.
