...
=item DBD::Pg 1.22 (optional)

=item DBD::mysql 3.0007 (optional)
...
=item Apache::Request (optional)

=item Apache2::Request (optional)

=back

The fact that these are maked "(optional)" is just to help the installer
