...
server to properly start up with SSL. See "Building Certificate" below for more
detailed instructions on building your SSL certificate.
...
Enter "n" or you'll have to type in a passphrase every time you start Apache.
