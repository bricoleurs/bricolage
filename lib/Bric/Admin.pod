...
And now PostgreSQL is ready to go!When all of the basic software components have
been installed, start PostgreSQL. You can use one of the scripts in startup/ if
you like.
