...
B<SSL_ENABLE:> Turn on this boolean directive to enable SSL support. Make sure
you've followed the installation instructions for building a mod_ssl Apache.
Disabled by default.
