...
Install PostgreSQL 7.1 or greater. Be sure to use UNICODE for data encoding.
...
F<comp/media/html>. Download it from
L<http://www.interactivetools.com/products/htmlarea/> and simply rename the
decompressed archive file to F<comp/media/html> in your Bricolage root.
