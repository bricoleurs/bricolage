...
Add PL/pgSQL to your installation. Certain internal functions used by
Bricolage rely on this language, and although Bricolage will attempt to
install it for you, it's best for you to do it at this point yourself.

  su - postgres "/usr/local/pgsql/bin/createlang plpgsql template1"
