...
already set up for you running under Ubuntu. See 
L<http://www.bricolage.cc/news/announce/2008/06/01/vmware/> for more details.

There are lots of hints and tips for installation at the Bricolage Wiki, 
L<http://wiki.bricolage.cc/bin/view/Bric/InstallationTips>, along with other
tutorials and useful bits.
...
Install PostgreSQL 7.3 or greater (8.1+ preferred) or MySQL 5.0.3 or greater.
...
L<http://marc.theaimsgroup.com/?l=bricolage-general>. Failing that, please
...
L<http://bugzilla.bricolage.cc/>. Include a copy of all F<*.db> files
...
Download the latest Bricolage sources from L<http://bricolage.cc/>. Decompress
them into F</usr/local/bricolage>.
...
L<http://www.dynarch.com/projects/htmlarea/>, decompress the files, and move
...
Bricolage UI, simply download it from L<http://www.xinha.org/>, decompress the
...
the Bricolage UI, simply download it from L<http://www.fckeditor.net/>,
decompress the files, and move them to the F<comp/media/wysiwyg/fckeditor>
...
manually install libssh2, which can be found at L<http://www.libssh2.org/>.
You will also need to install the Net::SSH2 module from the CPAN. If you've
installed your own SSL toolkit such as OpenSSL, make sure that libssh2 is using 
the same version as your Bricolage instance.  
...
FCKeditor documenation at L<http://wiki.fckeditor.net/> for details. By
default, Bricolage sets up a very simple toolbar for FCKeditor (overriding its
"Default" toolbar set).
