...
#    use constant ERROR_URI => '/errors/error.html';
    ...
    # Search Settings
    use constant FULL_SEARCH => (defined $config->{FULL_SEARCH} ? $config->{FULL_SEARCH} : 1);
}
...
$Log: Config.pm,v $
Revision 1.1  2001-09-06 21:52:50  wheeler
Initial revision
